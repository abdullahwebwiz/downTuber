      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="container px-6 py-12 mx-auto">
          <div className="text-center">
            <p className="font-medium text-pink-500 dark:text-pink-400">Contact us</p>
          ...
          <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="flex flex-col items-center justify-center text-center">
              <span className="p-3 text-pink-500 rounded-full bg-pink-100/80 dark:bg-gray-800">
                <svg
              ...
              <p className="mt-2 text-pink-500 dark:text-pink-400">abdullahwebwiz@gmail.com</p>
            </div>
            ...
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <p className="mt-2 text-pink-500 dark:text-pink-400">
                1st Floor, Blue Moon Mart, Pindi Road, Kohat
              </p>
            </div>
            ...
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <p className="mt-2 text-pink-500 dark:text-pink-400">+92 (319) 944-3575</p>
            </div>
          </div>
        </div>
      </section>
